...
## @purinton/skeleton [![npm version](https://img.shields.io/npm/v/@purinton/skeleton.svg)](https://www.npmjs.com/package/@purinton/skeleton)[![license](https://img.shields.io/github/license/purinton/skeleton.svg)](LICENSE)[![build status](https://github.com/purinton/skeleton/actions/workflows/nodejs.yml/badge.svg)](https://github.com/purinton/skeleton/actions)
...
1. Copy `skeleton.service` to `/usr/lib/systemd/system/skeleton.service`.
